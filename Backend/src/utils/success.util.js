function registerSuccessHtml(user) {
    return `
    <!DOCTYPE html>
    <html lang="en">
    <head>
                        ...
                        <tr>
                            <td style="padding: 36px 40px;">
                                ...
                                <p style="margin: 0 0 28px; color: #b0b0b0; font-size: 15px; line-height: 1.6;">
                                    Your Perplexity account is all set up and ready to go. Here are your account details:
                                </p>
                                            ...
                                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0">
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="padding: 8px 0; text-align: right;">
                                                        <span style="background-color: rgba(34,197,94,0.15); color: #4ade80; padding: 4px 12px; border-radius: 20px; font-size: 13px; font-weight: 600;">Active</span>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                                ...
                                <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="margin-top: 32px;">
                                    <tr>
                                        <td align="center">
                                            <a href="${process.env.CLIENT_URL || '#'}" style="display: inline-block; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: #ffffff; text-decoration: none; padding: 14px 36px; border-radius: 10px; font-size: 15px; font-weight: 600; letter-spacing: 0.3px;">
                                                Get Started →
                                            </a>
                                        </td>
                                    </tr>
