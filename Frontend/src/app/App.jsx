...
export default function App() {
  ...
  // Redirect to login if session check is complete and no user exists
  useEffect(() => {
  ...
  return (
    <div className="min-h-screen flex bg-zinc-950 text-zinc-100 antialiased font-sans overflow-hidden">
      
      {/* Sidebar Layout */}
      <aside className="w-60 border-r border-zinc-900 bg-zinc-950 p-6 flex flex-col justify-between hidden md:flex flex-shrink-0 z-20">
